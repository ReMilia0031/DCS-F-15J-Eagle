...
function default_1_pos_switch(hint_, device_, command_, arg_, arg_val_, arg_lim_)
	local arg_val_ = arg_val_ or 1
	local arg_lim_ = arg_lim_ or {0, 1}
	return {
...
-- Two position [ A / B ] Switches
function default_2_pos_switch(hint_, device_, command_, arg_, inversed_, sound_, animation_speed_)
	...
	return {
		...
		arg_value		= {val, -val},
		-- arg_lim			= {{0, 1}, {0, 1}},
		arg_lim			= {{-1, 1}, {-1, 1}}, -- Cockpit_F-15C.edm defined Switches [-1, 1]
		updatable		= true,
		use_OBB			= true,
		animated		= {true, true},
...
-- Three position [ A / B / C ] Switches
function default_3_pos_switch(hint_, device_, command_, arg_, inversed_, sound_, animation_speed_)
	local animation_speed_ = animation_speed_ or anim_speed_default
	local cycled = false
...
-- Three Position Springload Switch
function springloaded_3_pos_switch(hint_, device_, command_, arg_, inversed_, sound_, animation_speed_)
	local animation_speed_ = animation_speed_ or anim_speed_default
	local val = 1
	if inversed_ then
		val = -1
...
-- Cyclable Multiple Position Switch
